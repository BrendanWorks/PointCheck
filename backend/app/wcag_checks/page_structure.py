...
() => {
    ...
    if (!lang.trim()) {
        issues.push({criterion:'3.1.1',severity:'major',
    ...
    if (!title) {
        issues.push({criterion:'2.4.2',severity:'major',
        ...
        issues.push({criterion:'2.4.2',severity:'minor',
    ...
    if(emptyAltOnMeaningful.length>0){
        issues.push({criterion:'1.1.1',severity:'major',
    ...
    if(filenameAlt.length>0){
        issues.push({criterion:'1.1.1',severity:'minor',
    ...
    if(h1s.length===0&&document.body){
        issues.push({criterion:'1.3.1',severity:'major',
    ...
    if(dupIds.length>0){
        issues.push({criterion:'4.1.1',severity:'major',
    ...
    if(blinkEls.length>0||marqueeEls.length>0){
        ...
        issues.push({criterion:'2.2.2',severity:'major',
    ...
    if(vagueLinks.length>0){
        issues.push({criterion:'2.4.4',severity:'major',
    ...
    if(ariaIssues.length>0){
        issues.push({criterion:'4.1.2',severity:'major',
